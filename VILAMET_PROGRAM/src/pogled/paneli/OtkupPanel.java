		...
		gl_pnlGlavniUlazni.setHorizontalGroup(
			gl_pnlGlavniUlazni.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlGlavniUlazni.createSequentialGroup()
					...
					.addGap(10)
					.addGroup(gl_pnlGlavniUlazni.createParallelGroup(Alignment.TRAILING, false)
						.addComponent(txtUlazniIzlaz, GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
						.addGroup(gl_pnlGlavniUlazni.createSequentialGroup()
							.addComponent(txtUlazniBrutoCena)
							.addPreferredGap(ComponentPlacement.RELATED))
						.addComponent(txtUlazniPdv)
						.addComponent(txtUlazniCena, GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
						.addComponent(txtUlazniUlaz)
						.addComponent(cmbUlazniAmbalaza, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(cmbUlazniProizvod, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(txtUlazniBruto))
				...
				.addGroup(gl_pnlOtkupGlavni.createSequentialGroup()
					...
					.addGroup(gl_pnlOtkupGlavni.createParallelGroup(Alignment.TRAILING, false)
						...
						.addGroup(Alignment.LEADING, gl_pnlOtkupGlavni.createSequentialGroup()
							.addComponent(pnlGlavniUlazni, GroupLayout.PREFERRED_SIZE, 515, GroupLayout.PREFERRED_SIZE)
							.addGap(31)
