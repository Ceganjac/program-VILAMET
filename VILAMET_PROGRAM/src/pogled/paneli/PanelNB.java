...
public class PanelNB extends JPanel {
	...
	public PanelNB() {
		...
		GradientPanel Meni_Panel_NB = new GradientPanel();
		...
		Dugme_pregled_branja.setIcon(new ImageIcon(PanelNB.class.getResource("/pogled/slike/lista.png")));
		...
		Dugme_proizvodjaci.setIcon(new ImageIcon(PanelNB.class.getResource("/pogled/slike/ljudi.png")));
		...
		Dugme_proizvod.setIcon(new ImageIcon(PanelNB.class.getResource("/pogled/slike/proizvod.png")));
