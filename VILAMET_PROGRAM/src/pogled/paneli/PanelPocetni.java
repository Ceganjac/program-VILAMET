...
public class PanelPocetni extends JPanel {
	...
	public PanelPocetni(CardLayout cl, JPanel contentPane) {
		...
		Pocetni_Panel.setBackground(Color.white);
		add(Pocetni_Panel);

		JPanel Panel_dd = new JPanel();
		//Panel_dd.setBackground(new Color(255, 0, 0, 100));
		Panel_dd.setBackground(Color.green);
		Panel_dd.setSize(300, screenVisina);
		...
		gl_Panel_dd.setHorizontalGroup(gl_Panel_dd.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Panel_dd.createSequentialGroup().addContainerGap(98, Short.MAX_VALUE).addComponent(Pozdrav)
						.addGap(69))
				.addGroup(gl_Panel_dd.createSequentialGroup().addContainerGap(50, Short.MAX_VALUE)
						.addGroup(gl_Panel_dd.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblNewLabel, GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE).addComponent(
										Dugme_Pocetak, GroupLayout.PREFERRED_SIZE, 238, GroupLayout.PREFERRED_SIZE))
						.addGap(44)));
		gl_Panel_dd.setVerticalGroup(gl_Panel_dd.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Panel_dd.createSequentialGroup().addGap(249)
						...
						.addGap(18).addComponent(Pozdrav).addContainerGap(389, Short.MAX_VALUE)));
