			...
			gl_pnlProizvod.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlProizvod.createSequentialGroup()
					...
					.addGroup(gl_pnlProizvod.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(pnlProizvodNovi, GroupLayout.PREFERRED_SIZE, 490, GroupLayout.PREFERRED_SIZE))
					.addGap(352))
		);
			...
			gl_pnlProizvodNovi.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlProizvodNovi.createSequentialGroup()
					...
					.addGroup(gl_pnlProizvodNovi.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnlProizvodNovi.createSequentialGroup()
							.addComponent(lblNoviKlasa, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
							.addGap(10)
							.addComponent(txtNoviKlasa, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pnlProizvodNovi.createSequentialGroup()
							.addGroup(gl_pnlProizvodNovi.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNoviVrsta, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblNoviNaziv, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE))
							.addGap(10)
							.addGroup(gl_pnlProizvodNovi.createParallelGroup(Alignment.LEADING, false)
								.addComponent(txtNoviNaziv, GroupLayout.DEFAULT_SIZE, 220, GroupLayout.DEFAULT_SIZE)
								.addComponent(txtNoviVrsta, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)))
						.addGroup(gl_pnlProizvodNovi.createSequentialGroup()
							.addGroup(gl_pnlProizvodNovi.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNoviCena, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
							...
							.addGroup(gl_pnlProizvodNovi.createParallelGroup(Alignment.TRAILING)
								.addComponent(txtNoviCena, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
